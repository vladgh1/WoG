...
<head>
	...
	<link rel="stylesheet" href='<?= APPROOT ?>/public/src/css/register.css'>
</head>
...
<body>
	...
	<form method="post" action="register" class="center--container set-register-form-width">
		...
		<div class="main-login-register--container">
			...
			<!-- <a href="<?= APPROOT ?>/public/home/loggedIN" class="a--btn green--btn">Register</a>
			<a href="<?= APPROOT ?>/public/info/login" class="a--btn gray--btn">Or login instead</a> -->
		</div>
	</form>
